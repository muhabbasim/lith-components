  ...
  return (
    <div style={props.style}>
        ...
        <Container>
          <Row className="items-center justify-center">
            <m.div {...fadeIn} className="col-8 col-lg-3 offset-lg-1 col-md-5 col-sm-6 md:mb-[50px]" >
              <img height="" width="" src="https://via.placeholder.com/775x575" alt="" />
            </m.div>
            <m.div {...{ ...fadeIn, transition: { delay: 0.6 } }} className="col-12 col-lg-6 offset-lg-1 visible" >
              <h5 className="font-medium tracking-[-1px] text-darkgray font-serif mb-[25px] md:text-center lg:mb-[15px]">Early bird coffee identity</h5>
            ...
            <m.div {...fadeIn} className="col-12 col-md-12 text-center flex my-[4rem] items-center flex-row" >
              <span className="h-[1px] bg-mediumgray w-full"></span>
              <img height="" width="" src="https://via.placeholder.com/115x115" alt="" />
              <span className="h-[1px] bg-mediumgray w-full"></span>
            </m.div>
        ...
        <Container>
          <Row className="mb-24 sm:mb-20">
            <m.div {...fadeInRight} className="col-12 col-md-6 sm:mb-8">
              <img height="" width="" src="https://via.placeholder.com/800x846" alt="" />
            </m.div>
      ...
      <section className="py-[130px] overflow-hidden lg:py-[90px] md:py-[75px] sm:py-[50px]">
        <Container>
          <m.div {...fadeIn} className="row">
            <Col md={12}>
              <img height="" width="" src="https://via.placeholder.com/1200x750" alt="" className="mb-16 sm:mb-8" />
              <img height="" width="" src="https://via.placeholder.com/1200x750" alt="" className="mb-16 sm:mb-8" />
              <img height="" width="" src="https://via.placeholder.com/1200x750" alt="" />
            </Col>
          </m.div>
        </Container>
      </section>
      ...
      <section
        ...
        style={{
          backgroundImage: "url(https://via.placeholder.com/1920x735)",
        }}
      >
        <Container fluid>
            ...
            <Col md={8}>
              <Row lg={3} className="justify-center row-cols-1">
                <m.div {...fadeIn} className="col text-center md:mb-[20px]">
                  <img height="" width="" src="https://via.placeholder.com/800x973" alt="" />
                  <span className="mt-[30px] font-medium text-darkgray text-md font-serif uppercase block"> BLACK COFFEE </span>
                </m.div>
                <m.div {...{ ...fadeIn, transition: { delay: 0.6 } }} className="col text-center md:mb-[20px]">
                  <img height="" width="" src="https://via.placeholder.com/800x973" alt="" />
                  <span className="mt-[30px] font-medium text-darkgray text-md font-serif uppercase block"> TURKISH COFFEE </span>
                </m.div>
                <m.div {...{ ...fadeIn, transition: { delay: 0.8 } }} className="col text-center">
                  <img height="" width="" src="https://via.placeholder.com/800x973" alt="" />
                  <span className="mt-[30px] font-medium text-darkgray text-md font-serif uppercase block"> VACUUM COFFEE </span>
                </m.div>
              </Row>
            </Col>
          </Row>
