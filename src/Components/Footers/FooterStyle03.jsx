...
import logo from '../../Assets/hadaf_img/hr_dev_logo2.png'
                ...
                <Container>
                    <Row className="justify-between md:justify-start">
                        <Col lg={{ span: 3, order: 0 }} sm={{ span: 6, order: 1 }} className="md:mb-[40px] xs:mb-[25px]">
                            <span className="font-serif font-medium block text-themecolor mb-[20px] xs:mb-[10px]"><Translatable>HRDF Programm</Translatable></span>
                            <p className="md:w-9/12 xs:w-full"><Translatable>The HRDF initiative contributes to increasing of individual qualifications</Translatable></p>
                        </Col>
                        ...
                        <Col xl={{ span: 3 }} lg={{ span: 4, order: 0, }} sm={{ span: 6, order: 3 }} md={5}>
                            <span className="font-serif font-medium block text-themecolor mb-[20px] xs:mb-[10px]"><Translatable>Subscribe to newsletter</Translatable></span>
                            <p className="mb-[25px] md:mb-[20px]"><Translatable>Enter your email address for receiving valuable newsletters</Translatable></p>
                            <Formik
                                initialValues={{ email: '' }}
                    ...
                    <Row className='flex  items-center justify-center'>
                        <Col md={3} className="sm:mb-[20px]">
                            <Link aria-label="link" to="/" className="sm:flex sm:justify-center">
                                <img src={logo} alt="logo" width="111" height="36" />
                            </Link>
                        </Col>
                        <Col md={6} className="flex justify-center sm:mb-[20px]">
                            <p className="mb-0 xs:text-center">&copy; {new Date().getFullYear()} <Translatable>HRDF Programm</Translatable> </p>
                        </Col>
                        <Col md={3}>
