...
import Translatable from '../../Components/translatable_text/Translatable.jsx'
    ...
    <div className={`${props.mobileMenu ? `mobile-menu-${props.mobileMenu}` : ""}${props.className ? ` ${props.className}` : ""}`}>
      <ul className="navbar-nav text-black">
        ...
        <li className={`nav-item`}>
          <span className="nav-link text-black"><Translatable>Home</Translatable></span>
        </li>
        <li className={`nav-item`}>
          <span className="nav-link  text-black"><Translatable>Services</Translatable></span>
        </li>
        <li className={`nav-item`}>
          <span className="nav-link  text-black"><Translatable>About Us</Translatable></span>
        </li>
        <li className={`nav-item`}>
          <span className="nav-link  text-black"><Translatable>Contact Us</Translatable></span>
        </li>
        <li className={`nav-item`}>
          <span className="nav-link  text-black"><Translatable>Register</Translatable></span>
        </li>
        <li className={`nav-item`}>
          <span className="nav-link  text-black"><Translatable>Login</Translatable></span>
        </li>
        <Language/>
      </ul>
    </div>
